...
closeButton.addEventListener("click", function() {
    mobileMenu.style.transform = "translateX(100%)"
            ...
            >
              <nav className="token-gating-for-angular-centered-desktop">
                <div className="token-gating-for-angular-left">
                  ...
                  <div className="token-gating-for-angular-links">
                    <Link href="/token-gating-platform">
                      <a className="token-gating-for-angular-link01 Link">
                        Platform
                      </a>
                    </Link>
                    <Link href="/token-gating-solutions">
                      <a className="token-gating-for-angular-link02 Link">
                        Solutions
                      </a>
                    </Link>
                    <Link href="/blog">
                      <a className="token-gating-for-angular-link03 Link">
                        <span>Blog</span>
                        <br></br>
                      </a>
                    </Link>
                ...
                <div className="token-gating-for-angular-right">
                  ...
                  <Link href="/book-a-demo">
                    <a className="token-gating-for-angular-link04">
              ...
              <nav className="token-gating-for-angular-centered-mobile">
                <div className="token-gating-for-angular-left1">
                  <div className="token-gating-for-angular-links1">
                    <Link href="/token-gating-platform">
                      <a className="token-gating-for-angular-link05 Link">
                        Platform
                      </a>
                    </Link>
                    <Link href="/token-gating-solutions">
                      <a className="token-gating-for-angular-link06 Link">
                        Solutions
                      </a>
                    </Link>
                    <Link href="/blog">
                      <a className="token-gating-for-angular-link07 Link">
                        <span>Blog</span>
                        <br></br>
                      </a>
                    </Link>
          ...
          <header className="token-gating-for-angular-header">
            <h1 className="token-gating-for-angular-text09">
              Token Gating for Angular
            </h1>
            <p className="token-gating-for-angular-text10">
        ...
        <section className="token-gating-for-angular-features">
          <div className="token-gating-for-angular-title">
            <span className="token-gating-for-angular-text11">
              <span>
            ...
            <span className="token-gating-for-angular-text15">
              <span>
          ...
          <div className="token-gating-for-angular-cards">
            <div className="token-gating-for-angular-container1">
              <div className="card">
                ...
                />
                <span className="token-gating-for-angular-text18">
                  Schedule
                </span>
              ...
              <div className="token-gating-for-angular-publish card">
                ...
                />
                <span className="token-gating-for-angular-text20">Publish</span>
            ...
            <div className="token-gating-for-angular-container2">
              <div className="card token-gating-for-angular-analyze">
                ...
                />
                <span className="token-gating-for-angular-text22">Analyze</span>
              ...
              <div className="card">
                ...
                />
                <span className="token-gating-for-angular-text24">
                  Get leads
                </span>
                <span className="token-gating-for-angular-text25">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor
                </span>
              </div>
          ...
          <section className="token-gating-for-angular-content">
            <div className="token-gating-for-angular-centered-container">
              ...
              <div className="token-gating-for-angular-right1">
                <h2 className="token-gating-for-angular-text26 title">
                  <span>
                ...
                <div className="token-gating-for-angular-category">
                  <span className="token-gating-for-angular-text29">
                    <span>
            ...
            <h2 className="token-gating-for-angular-text36 title">
            ...
            <div className="token-gating-for-angular-blog">
              <div className="token-gating-for-angular-container3">
                <Link href="/about-token-gating-platforms">
                  <a className="token-gating-for-angular-link08">
                    <BlogPostCardFinal
              ...
              <div className="token-gating-for-angular-container4">
                <Link href="/an-introduction-to-nft-token-gating">
                  <a className="token-gating-for-angular-link09">
                    <BlogPostCardFinal
              ...
              <div className="token-gating-for-angular-container5">
                <Link href="/unlock-token-gate-signature-request">
                  <a className="token-gating-for-angular-link10">
                    <BlogPostCardFinal
      ...
      <style jsx>
        {`
          ...
          .token-gating-for-angular-centered-desktop {
            width: 100%;
            display: flex;
            max-width: 1280px;
            box-sizing: initial;
          ...
          .token-gating-for-angular-link01 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          .token-gating-for-angular-link02 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          .token-gating-for-angular-link03 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          ...
          .token-gating-for-angular-link04 {
            display: contents;
          }
          ...
          .token-gating-for-angular-centered-mobile {
            width: 100%;
            display: none;
            max-width: 1280px;
            box-sizing: initial;
          ...
          .token-gating-for-angular-left1 {
            height: 100%;
            display: flex;
            align-items: center;
            padding-top: 38px;
          ...
          .token-gating-for-angular-links1 {
            align-items: center;
            margin-left: 33px;
            flex-direction: row;
          }
          .token-gating-for-angular-link05 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          .token-gating-for-angular-link06 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          .token-gating-for-angular-link07 {
            color: var(--dl-color-gray-white);
            font-size: 18px;
            text-decoration: none;
          }
          ...
          .token-gating-for-angular-text10 {
          ...
          .token-gating-for-angular-text11 {
            font-size: 56px;
            font-style: normal;
            text-align: center;
            font-weight: 700;
          ...
          .token-gating-for-angular-text15 {
            font-size: 20px;
            margin-top: 16px;
            text-align: center;
            line-height: 30px;
          ...
          .token-gating-for-angular-text25 {
            line-height: 24px;
          }
          ...
          .token-gating-for-angular-text26 {
            font-size: 30px;
            text-align: left;
            line-height: 1.25em;
          }
          ...
          .token-gating-for-angular-text29 {
            color: rgb(0, 0, 0);
            font-size: 18px;
            line-height: 24px;
            margin-bottom: 0px;
          ...
          .token-gating-for-angular-link08 {
            display: contents;
          }
          ...
          .token-gating-for-angular-link09 {
            display: contents;
          }
          ...
          .token-gating-for-angular-link10 {
            display: contents;
          }
