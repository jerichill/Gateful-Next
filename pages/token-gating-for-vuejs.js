    ...
    mobileMenu.style.transform = "translateX(100%)"
            ...
            <div className="token-gating-for-vuejs-blog">
              <div className="token-gating-for-vuejs-container3">
                <Link href="/about-token-gating-platforms">
                  <a className="token-gating-for-vuejs-link08">
                    <BlogPostCardFinal
              ...
              <div className="token-gating-for-vuejs-container4">
                <Link href="/an-introduction-to-nft-token-gating">
                  <a className="token-gating-for-vuejs-link09">
                    <BlogPostCardFinal
              ...
              <div className="token-gating-for-vuejs-container5">
                <Link href="/unlock-token-gate-signature-request">
                  <a className="token-gating-for-vuejs-link10">
                    <BlogPostCardFinal
          ...
          <div className="token-gating-for-vuejs-top">
            ...
            <span className="token-gating-for-vuejs-text38">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="token-gating-for-vuejs-link11"
              >
                OpenMedium, Inc
              </a>
              <span>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="token-gating-for-vuejs-link12"
              >
                TekSun, Inc.
              </a>
            </span>
            <span className="token-gating-for-vuejs-text41">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="token-gating-for-vuejs-link13"
              >
                Legal
              </a>
            </span>
      ...
      <style jsx>
        {`
          ...
          .token-gating-for-vuejs-link11 {
            text-decoration: underline;
          }
          .token-gating-for-vuejs-link12 {
            text-decoration: underline;
          }
