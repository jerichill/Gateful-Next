  ...
  export default async function  checkAuth() {
    if (window.location.href =="https://gateful.io/demo") {
      ...
      if (verified == true && payload.baseUrl == window.location.href) {
        ...
        gatefulGatedImg.src =
          "https://tekdev.teksun.com/litprotocol/images/gateful-logo-blk1680670592.png";
        ...
        gatefulHeader.innerHTML = "This page is Token Gate Demo gated";
        ...
        gatefulPolicyMidText.style.marginTop = "20px";
