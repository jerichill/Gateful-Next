...
// Step 2: Create gateful2.js file (public/js/gateful2.js) 
// Step 3: Copy generated script and paste into the gateful2.js file (public/js/gateful2.js)
...
// import checkAuth2 from "../public/js/gateful2.js" file (public/js/gateful2.js)
// import { useRouter } from "next/dist/client/router";

// Put the code in app Function
/*     
  // Gateful protocol global code implementation code start
  // if multiple checkAuth function is there then result,result2 multiple call in check function like and in if condition result ,result2, call in as condition 
...
// Step 7: Recompile or rebuild the Project to run the script
  ...
  export default async function  checkAuth2() {
    if (window.location.href =="https://gateful.io/etherfelis") {
      ...
      if (verified == true && payload.baseUrl == window.location.href) {
        ...
        gatefulGatedImg.src =
        "https://app.gateful.io/backend/images/group52@2x1681452642.png";
  ...
  async function generateAndVerifiedJWT2() {
    ...
    var unifiedAccessControlConditions = [{"conditionType":"evmBasic","contractAddress":"","standardContractType":"","chain":"ethereum","method":"eth_getBalance","parameters":[":userAddress","latest"],"returnValueTest":{"comparator":">=","value":"1000000000"}}]
