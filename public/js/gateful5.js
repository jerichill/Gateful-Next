...
//From here the dynamic script is started [# Copy the code for Step 3]
  ...
  export default async function  checkAuth5() {
    if (window.location.href =="https://gateful.io/xdai") {
      ...
      if (verified == true && payload.baseUrl == window.location.href) {
        ...
        gatefulHeader.innerHTML = "Open Medium";
  ...
  async function generateAndVerifiedjwt5() {
    ...
    var unifiedAccessControlConditions = [{"conditionType":"evmBasic","contractAddress":"","standardContractType":"","chain":"ethereum","method":"eth_getBalance","parameters":[":userAddress","latest"],"returnValueTest":{"comparator":">=","value":"1000000000000"}},{"operator":"and"},{"conditionType":"evmBasic","contractAddress":"0x9dcf6c78B1C50d0A729ed818733dfd105D562A3A","standardContractType":"ERC721","chain":"ethereum","method":"balanceOf","parameters":[":userAddress"],"returnValueTest":{"comparator":">=","value":"1"}}]
